...
한편 `docs/tile_based/spec/architecture/dataflow_te_ve.md`는 TE→VE 경계에
**STB(Shared Tile Buffer)** 라는 “디스크립터 스트림 경계(ready/valid)”를 명시한다.
...
2) `docs/tile_based/spec/architecture/*`에는 “메인 스펙으로 승격됨” 링크를 추가  
3) 검증 체크리스트에 STB/descriptor 관련 항목을 포함
